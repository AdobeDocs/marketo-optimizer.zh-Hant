...
+ 同事功能 {#coworker}
  ...
  + [依角色個人化電子郵件內容](./agents/personalize-content.md)
  + [建立自訂評分模型](./agents/lead-scoring-model.md)
  + [建立和推廣網路研討會](./agents/webinar-creation.md)
  + [監視和偵錯歷程進度](./agents/journey-observability.md)
  + [設定和分析目的](./agents/intent.md)
  + [產生分析報表](./agents/surface-analytics.md)
+ AI決策 {#ai-decisioning}
  + [概觀](./agents/ai-decisioning.md)
  + [AI決策健康狀態](./agents/ai-decisioning-health.md)
+ 行銷管理 {#marketing-management}
  ...
  + 網路研討會頻道 {#webinar-channel}
    + [概觀](./marketing/webinars-overview.md)
    + [建立網路研討會](./marketing/create-webinar.md)
    + [網路研討會歷程](./marketing/webinar-journeys.md)
...
+ 報告 {#reports}
  ...
  + [Experience Platform資料集](./reports/aep-datasets.md)
+ 客群 {#audiences}
