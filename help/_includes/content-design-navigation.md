...
當您在視覺化設計空間中使用內容時，可以使用導覽樹狀結構來存取元件、欄和內容元素。 按一下左側的&#x200B;_[!UICONTROL 導覽樹狀結構]_&#x200B;圖示（![導覽樹狀結構圖示](../user-guide/assets/do-not-localize/icon-navigation-tree.svg)）以顯示樹狀結構。

![存取內容層](../user-guide/content/assets/content-design-layers.png){width="800" zoomable="yes"}
...
1. 在欄工具列中，按一下&#x200B;_[!UICONTROL 選取欄]_&#x200B;工具，然後選擇您要編輯的工具。
   ...
   在視覺化設計工具中顯示的![欄元件](../user-guide/content/assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
...
1. 若要編輯欄屬性，請按一下右側的&#x200B;_[!UICONTROL 樣式]_&#x200B;索引標籤，並根據您的需求加以變更：
   ...
   * 展開&#x200B;**[!UICONTROL 進階]**&#x200B;區段以定義資料行的內嵌樣式。
   ...
   ![變更所選資料行的樣式](../user-guide/content/assets/content-design-layers-column-styles.png){width="700" zoomable="yes"}
